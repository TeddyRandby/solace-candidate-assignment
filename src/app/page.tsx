            ...
            return (
              <tr className="group" key={advocate.id}>
                ...
                <td className="border-b border-gray-100 p-4 pl-8 text-gray-500 group-hover:bg-gray-100 group-hover:text-gray-900">
                  <button className="select-none text-gray-900 hover:bg-gray-900 hover:text-white  transition-all rounded-lg py-2 px-2 text-center align-middle font-sans text-xs font-bold uppercase hover:shadow-lg hover:shadow-gray-900/20 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none" popoverTarget={`specialties-${advocate.id}`}>
